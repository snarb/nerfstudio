...
class CSVMetricWriter(Writer):
    ...
    FIELD_MAP = {
        ...
        "Train Metrics Dict/num_samples_per_batch": "train_num_samples_per_batch",
        "Train Metrics Dict/cumulative_point_samples": "cumulative_point_samples",
        "Train Metrics Dict/target_num_samples_per_batch": "target_num_samples_per_batch",
        "Train Metrics Dict/train_rays_per_batch": "train_rays_per_batch",
        "Train Metrics Dict/next_train_rays_per_batch": "next_train_rays_per_batch",
        "Train Metrics Dict/dynamic_samples_per_ray_ema": "dynamic_samples_per_ray_ema",
        "Train Metrics Dict/feature_reweighting_strength": "feature_reweighting_strength",
        "Train Metrics Dict/adaptive_samples_mean": "train_adaptive_samples_mean",
        "Train Metrics Dict/adaptive_samples_max": "train_adaptive_samples_max",
        "Train Metrics Dict/adaptive_saturation_rate": "train_adaptive_saturation_rate",
        "Eval Loss": "eval_loss",
        "Eval Loss Dict/rgb_loss": "eval_rgb_loss",
        "Eval Metrics Dict/psnr": "eval_batch_psnr",
        "Eval Metrics Dict/num_samples_per_batch": "eval_num_samples_per_batch",
        "Eval Metrics Dict/adaptive_samples_mean": "eval_adaptive_samples_mean",
        "Eval Metrics Dict/adaptive_samples_max": "eval_adaptive_samples_max",
        "Eval Metrics Dict/adaptive_saturation_rate": "eval_adaptive_saturation_rate",
    ...
    FIELDNAMES = [
        ...
        "train_rgb_loss",
        "train_psnr",
        "train_num_samples_per_batch",
        "cumulative_point_samples",
        "target_num_samples_per_batch",
        "train_rays_per_batch",
        "next_train_rays_per_batch",
        "dynamic_samples_per_ray_ema",
        "feature_reweighting_strength",
        "train_adaptive_samples_mean",
        "train_adaptive_samples_max",
        "train_adaptive_saturation_rate",
        "eval_loss",
        "eval_rgb_loss",
        "eval_batch_psnr",
        "eval_num_samples_per_batch",
        "eval_adaptive_samples_mean",
        "eval_adaptive_samples_max",
        "eval_adaptive_saturation_rate",
        "eval_image_psnr",
        "eval_image_ssim",
        "eval_image_lpips",
        "eval_all_psnr",
