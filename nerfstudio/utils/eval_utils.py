...
def eval_load_checkpoint(config: TrainerConfig, pipeline: Pipeline) -> Tuple[Path, int]:
    ...
    # These are trusted local Nerfstudio checkpoints. Preserve the historical
    # pre-PyTorch-2.6 behavior so optimizer/scaler NumPy scalars do not make
    # evaluation fail under the new weights_only=True default.
